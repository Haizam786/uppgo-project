...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        changeMessageValue(state, seekerTable){
            state.seekerTable = seekerTable
        },
    },
    getters: {
        layout(state) {
        ...
        getMessage(state){
            return state.seekerTable;
        },
    },
    actions: {
        changeMessageValue(context, seekerTable){
            context.commit('changeMessageValue', seekerTable)
          },
    },
    modules: {}
});
