            ...
            <header class="header navbar navbar-expand-sm">
                        ...
                        <router-link to="/dashboard">
                            <div class="d-flex">
                                <div v-if="organisations[0].logo">
                                    <img
                                        :src="'/storage/profile/'+ organisations[0].logo"
                                        class="navbar-logo"
                                        alt="logo"
                                    />
                                </div>
                ...
                <div class="navbar-item flex-row ml-md-auto">
                    ...
                    >
                        <template #button-content>
                            <img
                                v-if="selectedLang"
                                :src="
                                    require(`@/assets/images/flags/${selectedLang.code}.png`)
                                "
                                class="flag-width"
                                alt="flag"
                            />
                        ...
                        <perfect-scrollbar>
                            ...
                            >
                                <img
                                    :src="
                                        require(`@/assets/images/flags/${item.code}.png`)
                                    "
                                    class="flag-width"
                                    alt=""
                                />
                    ...
                    <b-dropdown
                        ...
                        variant="icon-only"
                        toggle-class="nav-link"
                        class="nav-item message-dropdown"
                        :right="true"
                    >
                        <template #button-content>
                            <svg
                        ...
                        <b-dropdown-item v-for="mail_log in mail_logs" :key="mail_log.id" >
                            <b-media class="media">
                                <template #aside>
                                    <img
                                        v-if="mail_log.customer_image"
                                        :src="'/storage/customers/'+ mail_log.customer_image"
                                        alt="avatar"
                                    />
                                    <img
                                        v-else
                                ...
                                <p class="msg-title"> <i>{{$t('invoice_sent')}} : </i> {{ mail_log.currency }} {{ mail_log.amount }}</p>
                            </b-media>
                        </b-dropdown-item>
                    ...
                    >
                        <template #button-content>
                            <div v-if="logged_user.image_path">
                                <img
                                    :src="'/storage/admins/'+ logged_user.image_path"
                                    alt="avatar"
                                />
                            </div>
                            ...
                            <div v-else>
                                <img
                                    :src="require('@/assets/images/dummy_profile.png')"
                                    alt="avatar"
                                />
                            </div>
                        </template>
                    ...
                    <li class="menu single-menu">
                        ...
                        >
                            ...
                            <router-link tag="li" to="/pages/faq"
                                ><a>FAQ</a></router-link
                            >
                            <router-link tag="li" to="/pages/faq2"
                            ...
                            >
                            <li>
                                <a target="_blank" href="/pages/coming-soon"
                                    >Coming Soon</a
                                >
                            </li>
                            ...
                            <li class="sub-sub-submenu-list">
                                ...
                                >
                                    <li>
                                        <a target="_blank" href="/auth/login"
                                            >Login Cover</a
                                        >
                                    </li>
                                    <li>
                            ...
                            <li class="sub-sub-submenu-list">
                                ...
                                >
                                    <li>
                                        <a target="_blank" href="/auth/register"
                                            >Register Cover</a
                                        >
                                    </li>
                                    <li>
