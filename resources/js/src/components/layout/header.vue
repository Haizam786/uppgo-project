        ...
        <div class="header-container fixed-top">
            <header class="header navbar navbar-expand-sm">
                    ...
                    <li class="nav-item theme-logo">
                        <router-link to="/dashboard">
                            <div class="d-flex">
                                ...
                                <div v-else>
                                    <img src="@/assets/images/dummy_profile.png" class="navbar-logo" alt="logo" />
                                </div>
                            </div>
                        </router-link>
                    </li>
                ...
                <div class="d-none horizontal-menu">
                    <a href="javascript:void(0);" class="sidebarCollapse" data-placement="bottom" @click="
                        $store.commit(
                            'toggleSideBar',
                ...
                <!-- <ul class="navbar-item flex-row ml-md-0 ml-auto">
                    ...
                    >
                        ...
                        <form
                            ...
                            :class="{
                                'input-focused': $store.state.is_show_search,
                            }"
                        >
                ...
                <div class="navbar-item flex-row ml-md-auto">
                    ...
                    <b-dropdown toggle-tag="a" variant="icon-only" toggle-class="nav-link"
                        ...
                        <b-dropdown-item v-for="mail_log in mail_logs" :key="mail_log.id">
                            <b-media class="media">
                                <template #aside>
                                    <img v-if="mail_log.customer_image"
                                        :src="'/storage/customers/' + mail_log.customer_image" alt="avatar" />
                                    <img v-else src="@/assets/images/dummy_profile.png" alt="avatar" />
                                </template>
                                <h5 class="usr-name">{{ mail_log.customer_name }}</h5>
                                <p class="msg-title"> <i>{{ $t('invoice_sent') }} : </i> {{ mail_log.currency }} {{
                                    mail_log.amount }}</p>
                            </b-media>
                        </b-dropdown-item>
                    ...
                    <b-dropdown toggle-tag="a" variant="icon-only" toggle-class="nav-link"
                        menu-class="notification-scroll" class="nav-item notification-dropdown" :right="true">
                        <template #button-content>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div v-for="(activity, index) in activities" :index="index">
                            <b-dropdown-item>
                    ...
                    <div class="d-flex align-items-center justify-content-center ml-3">
                        <router-link to="/scan-qr">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-video video-call-screen">
                    ...
                    <b-dropdown toggle-tag="a" variant="icon-only" toggle-class="user nav-link"
                        ...
                        <template #button-content>
                            ...
                            <div v-else>
                                <img :src="require('@/assets/images/dummy_profile.png')" alt="avatar" />
                            </div>
                        </template>

                        <b-dropdown-item to="/profile" v-if="logged_user.type == 'Super Admin'">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <nav class="topbar">
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    <li class="menu single-menu">
                        <a href="javascript:;" data-toggle="collapse" aria-expanded="true"
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="javascript:;" data-toggle="collapse" aria-expanded="false"
                        ...
                        <ul class="collapse submenu list-unstyled" id="tables" data-parent="#topAccordion">
                            ...
                            <li class="sub-sub-submenu-list">
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="datatable" data-parent="#datatable">
                                    ...
                                    <router-link tag="li" to="/tables/multiple-tables"><a>Multiple
                                            Tables</a></router-link>
                                    <router-link tag="li" to="/tables/alt-pagination"><a>Alt.
                                    ...
                                    <router-link tag="li" to="/tables/live-dom-ordering"><a>Live DOM
                                            ordering</a></router-link>
    ...
    methods: {
        ...
        signOut() {
            axios.post("/logout")
                ...
                .catch((err) => console.log("Logout failed:", err.response?.status));
        },
        ...
        //Fetch last 3 mail activity logs from the database
        fetchMailLogs() {
            axios
                .get("/admin/fetch/mail-logs")
                .then((res) => {
                    if (res.status == 200) {
